...
SOURCES = {
    ...
    # ── 从 GOGLA Top Stories 发现的更多源 ──
    "geapp": {
        "name": "GEAPP Energy Alliance",
        "url": "https://energyalliance.org/feed/",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
        ...
        "keywords": ["africa", "african", "solar", "energy", "power",
                     ...
                     "kenya", "nigeria", "ethiopia", "ghana", "tanzania",
                     "mission 300", "electricity", "battery", "storage",
                     "last mile", "mini.grid", "universal access"],
    },
    "fsd-africa": {
        "name": "FSD Africa",
        "url": "https://fsdafrica.org/feed/",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
        "date_sel": "pubDate",
        "summary_sel": "description",
        "keywords": ["green", "renewable", "climate", "energy", "solar",
                     "off-grid", "offgrid", "mini-grid", "minigrid",
                     "electrification", "africa", "african",
                     "green transition", "jobs", "infrastructure",
                     "investment", "carbon", "emission"],
    },
    # ── RSS 来源 ──
    "pv-magazine": {
        "name": "PV Magazine",
